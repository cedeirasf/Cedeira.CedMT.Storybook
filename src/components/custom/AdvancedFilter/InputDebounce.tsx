        ...
        ; (field.filteringTips ?? []).forEach((tip) => {
          ...
          if (operator?.range) {
            ...
            if (dataType.scope === "time") {
              ...
              defaultTo = format(addDays(new Date(), 1), DEFAULT_VALUES.DATE_FORMAT)
            }
            ...
            validSuggestions.push({
              ...
              defaultValue: JSON.stringify({ from: defaultFrom, to: defaultTo }),
            })
          } else {
        ...
        <div className="absolute z-50 mt-1 w-full rounded-md border bg-popover shadow-md">
          <div ref={suggestionsRef} className="max-h-[300px] overflow-auto p-1 space-y-0.5">
            {suggestions.map((suggestion, index) => (
              ...
              >
                <div className="text-sm font-medium">{renderSuggestionContent(suggestion)}</div>
