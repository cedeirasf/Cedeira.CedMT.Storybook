...
const SheetHeader = ({ className, ...props }: React.ComponentProps<typeof BaseSheetHeader>) => (
  <BaseSheetHeader
...
const SheetFooter = ({ className, ...props }: React.ComponentProps<typeof BaseSheetFooter>) => (
  <BaseSheetFooter
    className={cn(
      "mt-auto flex-none",
      className
