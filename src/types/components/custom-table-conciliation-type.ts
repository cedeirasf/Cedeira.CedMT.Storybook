...
// Agregar la interfaz UpdatingRows y tipos relacionados que faltan
export interface UpdatingRowType {
  type: string
}

export interface UpdatingRowStyle {
  style: string[]
  delay: string
}

export interface UpdatingRowsScheme {
  [key: string]: UpdatingRowStyle
}

export interface UpdatingRows {
  scheme: UpdatingRowsScheme
  rows: UpdatingRowType[]
}
