...
const meta: Meta<typeof TimePicker> = {
  ...
  argTypes: {
    value: {
      control: "object",
      description: "El valor actual del TimePicker. Objeto con propiedades hours, minutes, seconds y period.",
    },
    onChange: {
      action: "changed",
    ...
    standalone: {
      control: "boolean",
      description: "Determina si el TimePicker se muestra como componente independiente sin Popover.",
      defaultValue: false,
    },
    error: {
      control: "text",
      description: "Mensaje de error para mostrar cuando el tiempo seleccionado es inválido.",
    },
  },
}
...
const createStory = (args: Partial<React.ComponentProps<typeof TimePicker>>): StoryObj<typeof TimePicker> => ({
  args,
  decorators: [
    (Story, context) => {
